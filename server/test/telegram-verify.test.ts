// server/test/telegramVerify.test.ts
import { expect, test } from 'bun:test'
import crypto from 'crypto'
import { telegramPlugin, verifyTelegramLogin } from '../src/auth/telegram'

const BOT_TOKEN = '123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11'

function sign(payload: Record<string, string>, botToken = BOT_TOKEN) {
...
test('telegramPlugin refuses to construct with no bot token at all', () => {
  expect(() => telegramPlugin({} as any)).toThrow()
})
