 ...
 *
 */
function resolveTrustProxy(value: unknown): boolean | number | string {
 ...
 *
 */
function resolveIpAddressStrategy(
  expressTrustProxy: boolean | number | string,
):
  | { mode: 'permissive' }
  | { mode: 'trustedProxies'; trustedProxies: string[] }
  | { mode: 'socket' } {
...
export { isAddressOrCIDR, resolveIpAddressStrategy, resolveTrustProxy }
