// @ts-check
// server/src/services/golbat-responses.js
//
...
class GolbatUnavailableError extends GolbatError {
  /** @param {string} message @param {{local?: boolean}} [opts] */
  constructor(message, { local = false } = {}) {
    super(message)
    this.local = local
  }
}
...
/**
 * @param {any} json
 * @returns {{fortInMemory: boolean, maxPokemonResults: number, maxFortResults: number}}
 */
...
/**
 * @param {any} json
 * @returns {{pokemon: object[], examined: number, skipped: number, total: number, limitReached: boolean}}
 */
function parsePokemonScanResponse(json) {
...
/**
 * @param {any} json
 * @returns {{gyms: object[], pokestops: object[], stations: object[], examined: number, skipped: number, total: number, limitReached: boolean}}
 */
function parseFortScanResponse(json) {
  if (
    !json ||
...
/** @param {any} json @returns {object[]} */
function parseAvailablePokemon(json) {
...
/** @param {any} json @returns {{raids: object[]}} */
function parseAvailableGyms(json) {
...
/** @param {any} json @returns {{showcase_focus_filter: boolean, quests: object[], invasions: object[], lures: object[], showcases: object[]}} */
function parseAvailablePokestops(json) {
  if (
    !json ||
...
/** @param {any} json @returns {{battles: object[]}} */
function parseAvailableStations(json) {
...
/** @param {any} json @returns {{gyms: object, pokestops: object, stations: object}} */
function parseAvailableForts(json) {
  if (
    !json ||
