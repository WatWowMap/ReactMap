// @ts-check
// server/src/services/delta-engine.js
//
...
/**
 * @typedef {{stamp: number, selfEvicts: boolean}} TrackedEntity
 */
 ...
 * @returns {number}
 */
function getChangeStamp(entity) {
 ...
 * }}
 */
function computeDelta(previousMap, rawEntities, options = {}) {
