// server/src/scripts/backfill-auth-users.ts
//
 ...
 */
const EXPECTED_CONFLICT_KEY: Record<string, string> = {
  auth_user: 'PRIMARY',
 ...
 *
 */
function isIdempotentConflict(table: string, error: any) {
...
export { backfillAuthUsers, insertIfAbsent, isIdempotentConflict }
