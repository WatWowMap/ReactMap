...
import {
  Menu, LocationOn, ZoomIn, ZoomOut, Forum, Create, Equalizer, Person,
...
export default function FloatingButtons({ toggleDrawer, setUserProfile }) {
  const theme = useTheme()
  const { t } = useTranslation()
  const classes = useStyles()
  const {
    map: {
      enableFeedback, feedbackLink, enableStats, statsLink, enableAccuracyCircle, locationBtnPosition,
    },
